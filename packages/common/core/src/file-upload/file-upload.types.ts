...
export interface FileUploadApiProps
  extends LocaleProperty, DirectionProperty, CommonProperties {
  /**
...
export interface ItemProps extends ItemTypeProps {
  file: File
  fileErrors?: FileError[] | undefined
}
...
export interface FileUploadApi {
  ...
  getDropzoneBindings: (
    props?: DropzoneProps & IdRegistrationProps,
  ...
  getItemBindings: (props: ItemProps) => FileUploadItemBindings
  getItemDeleteTriggerBindings: (
    props: ItemProps,
  ) => FileUploadItemDeleteTriggerBindings
  getItemGroupBindings: (props?: ItemGroupProps) => FileUploadItemGroupBindings
  getItemNameBindings: (props: ItemProps) => FileUploadItemNameBindings
  getItemPreviewBindings: (props: ItemProps) => FileUploadItemPreviewBindings
  getItemPreviewImageBindings: (
    props: ItemPreviewImageProps,
  ) => FileUploadItemPreviewImageBindings
  getItemSizeTextBindings: (props: ItemProps) => FileUploadItemSizeTextBindings
  getLabelBindings: (props: IdRegistrationProps) => FileUploadLabelBindings
  getRootBindings: (props: IdRegistrationProps) => FileUploadRootBindings
  getTriggerBindings: (props: IdRegistrationProps) => FileUploadTriggerBindings
}

type PartName = AnatomyPartName<typeof fileUploadAnatomy>
interface Part<P extends PartName>
  extends AnatomyPart<"fileUpload", P>, DirectionProperty {}

export interface FileUploadClearTriggerBindings extends Part<"clearTrigger"> {
...
export interface FileUploadDropzoneBindings extends Part<"dropzone"> {
...
export interface FileUploadHiddenInputBindings extends Part<"hiddenInput"> {
...
interface FileUploadItemDataBindings extends DirectionProperty {
  "data-disabled": BooleanDataAttr
  "data-type": ItemType
}

export interface FileUploadItemDeleteTriggerBindings extends Part<"itemDeleteTrigger"> {
  "aria-label": string | undefined
  "data-disabled": BooleanDataAttr
  "data-type": ItemType
  disabled: boolean
...
export interface FileUploadItemGroupBindings
  extends Part<"itemGroup">, FileUploadItemDataBindings {}

export interface FileUploadItemBindings
  extends Part<"item">, FileUploadItemDataBindings {
  "data-invalid": BooleanDataAttr
  id: string
}

export interface FileUploadItemNameBindings
  extends Part<"itemName">, FileUploadItemDataBindings {
  id: string
}

export interface FileUploadItemPreviewBindings
  extends Part<"itemPreview">, FileUploadItemDataBindings {
  id: string
}

export interface FileUploadItemPreviewImageBindings
  extends Part<"itemPreviewImage">, FileUploadItemDataBindings {
  alt: string | undefined
  src: string
}

export interface FileUploadItemSizeTextBindings
  extends Part<"itemSizeText">, FileUploadItemDataBindings {
  id: string
}

export interface FileUploadLabelBindings extends Part<"label"> {
  "data-disabled": BooleanDataAttr
...
export interface FileUploadRootBindings extends Part<"root"> {
  "data-disabled": BooleanDataAttr
  "data-dragging": BooleanDataAttr
  id: string
}

export interface FileUploadTriggerBindings extends Part<"trigger"> {
  "data-disabled": BooleanDataAttr
  "data-invalid": BooleanDataAttr
  disabled: boolean
  id: string
...
export interface FileUploadErrorTextBindings extends Part<"errorText"> {
  "aria-live": "polite"
  hidden: boolean
  id: string
}
