...
export namespace JSX {
  ...
  export interface AriaAttributes {
     ...
     * want to wait until the modifications are complete before exposing them to the
     * user.
     */
    ...
    /**
     * Indicates the element that represents the current item within a container or
    ...
    /**
     * Indicates whether a text box accepts multiple lines of input or only a single
     * line.
     */
    ...
    /**
     * Defines the number of items in the current set of listitems or treeitems. Not
