...
/**
 * Kanban diagram styles using QDS tokens.
 * Source: mermaid/packages/mermaid/src/diagrams/kanban/styles.ts
 */
...
.section--1 rect, .section--1 path, .section--1 circle, .section--1 polygon, .section--1 path {
  fill: var(--color-category-blue-medium);
  stroke: var(--color-category-blue-medium);
}
...
.section-0 rect, .section-0 path, .section-0 circle, .section-0 polygon, .section-0 path {
  fill: var(--color-category-purple-medium);
  stroke: var(--color-category-purple-medium);
}
...
.section-1 rect, .section-1 path, .section-1 circle, .section-1 polygon, .section-1 path {
  ...
  stroke: var(--color-category-green-medium);
}
.section-1 text { fill: var(--color-text-neutral-primary); }
.node-icon-1 { font-size: 40px; color: var(--color-text-neutral-primary); }
...
.section-2 rect, .section-2 path, .section-2 circle, .section-2 polygon, .section-2 path {
  fill: var(--color-category-cyan-medium);
  stroke: var(--color-category-cyan-medium);
}
...
.section-3 rect, .section-3 path, .section-3 circle, .section-3 polygon, .section-3 path {
  fill: var(--color-category-orange-medium);
  stroke: var(--color-category-orange-medium);
}
...
.section-4 rect, .section-4 path, .section-4 circle, .section-4 polygon, .section-4 path {
  fill: var(--color-category-magenta-medium);
  stroke: var(--color-category-magenta-medium);
}
...
.section-5 rect, .section-5 path, .section-5 circle, .section-5 polygon, .section-5 path {
  fill: var(--color-category-teal-medium);
  stroke: var(--color-category-teal-medium);
}
...
.section-6 rect, .section-6 path, .section-6 circle, .section-6 polygon, .section-6 path {
  fill: var(--color-category-kiwi-medium);
  stroke: var(--color-category-kiwi-medium);
}
...
.section-7 rect, .section-7 path, .section-7 circle, .section-7 polygon, .section-7 path {
  fill: var(--color-category-red-medium);
  stroke: var(--color-category-red-medium);
}
