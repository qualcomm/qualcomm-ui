...
@Component({
  imports: [AccordionCollapsibleDemo, AccordionCompositeDemo, AccordionCompositeLayoutDemo, AccordionControlledStateDemo, AccordionDefaultValueDemo, AccordionDisabledDemo, AccordionFocusCallbackDemo, AccordionIconDemo, AccordionMultipleDemo, AccordionSecondaryTextDemo, AccordionSimpleDemo, AccordionSimpleDirectivesDemo, AccordionSizeDemo, AccordionUncontainedDemo],
  ...
  template: `
    ...
    >
      ...
      <div class="section">
        ...
        <div class="demo-container">
          <accordion-composite-layout-demo />
        </div>
      </div>
      <div class="section">
