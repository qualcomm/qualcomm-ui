...
export interface FileUploadDropzoneTextGroupProps
  extends ElementRenderProp<"div"> {}

export function FileUploadDropzoneTextGroup(
  props: FileUploadDropzoneTextGroupProps,
): ReactElement {
  const qdsContext = useQdsFileUploadContext()
  const mergedProps = mergeProps(
    qdsContext.getDropzoneTextGroupBindings(),
    props,
  )
