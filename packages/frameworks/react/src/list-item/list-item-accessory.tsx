...
export interface ListItemAccessoryProps extends ElementRenderProp<"div"> {
  /**
...
export function ListItemAccessory({
  children,
  ...props
}: ListItemAccessoryProps): ReactElement {
  const qdsContext = useQdsListItemContext()
  const mergedProps = mergeProps(qdsContext.getAccessoryBindings(), props)
