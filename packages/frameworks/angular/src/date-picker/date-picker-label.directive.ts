...
import {CoreDatePickerLabelDirective} from "@qualcomm-ui/angular-core/date-picker"
 ...
 */
@Directive({
  selector: "[q-date-picker-label]",
  standalone: false,
})
export class DatePickerLabelDirective extends CoreDatePickerLabelDirective {
