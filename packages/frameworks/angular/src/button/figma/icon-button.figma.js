...
// url=<FIGMA_COMPONENTS_BASE>?node-id=22444-21587
...
const example = figma.code`<button${disabledAttr}${emphasisAttr} icon="${iconName}" q-icon-button${shapeAttr}${sizeAttr}${variantAttr}></button>`
