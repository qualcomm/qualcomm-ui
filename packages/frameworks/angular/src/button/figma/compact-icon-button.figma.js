...
const example = figma.code`<button density="compact"${disabledAttr}${emphasisAttr} icon="${iconName}" q-icon-button${shapeAttr}${sizeAttr}${variantAttr}></button>`
