...
<Demo component={demos.ToastActionDemo} />

### Toast Emphasis

Here's an example of each toast type.

<Demo component={demos.ToastEmphasisDemo} />
...
<Demo component={demos.ToastPauseDemo} />
...
<Demo component={demos.ToastMaxVisibleDemo} />
...
<Demo component={demos.ToastPlacementDemo} />
