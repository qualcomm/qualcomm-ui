...
<Demo component={demos.PaginationMetadataDemo} />

### Ranges

<Demo expanded component={demos.PaginationRangesDemo} />
...
<Demo expanded component={demos.PaginationControlledStateDemo} />
