...
::: terms
clear trigger, item indicator, subcomponents
:::

Build with the composite API for granular control. This API requires you to provide each subcomponent, but gives you full control over the structure and layout.

<Demo
  name="ComboboxCompositeDemo"
  component={demos.ComboboxCompositeDemo}
/>
...
<Demo
  name="ComboboxHighlightDemo"
  component={demos.ComboboxHighlightDemo}
/>
...
<Demo
  name="ComboboxAriaLabelDemo"
  component={demos.ComboboxAriaLabelDemo}
/>
...
<Demo
  name="ComboboxSameWidthDemo"
  component={demos.ComboboxSameWidthDemo}
/>
...
<Demo
  name="ComboboxItemGroupDemo"
  component={demos.ComboboxItemGroupDemo}
/>

### Custom Item Rendering

::: terms
custom option, rich item content
:::

When using the simple API, use the [renderItem](./#renderItem) prop to customize the rendering of each item.

<Demo
  name="ComboboxRenderItemDemo"
  component={demos.ComboboxRenderItemDemo}
/>
...
<Demo
  name="ComboboxMaxHeightDemo"
  component={demos.ComboboxMaxHeightDemo}
/>
...
::: terms
modal, nested combobox, portalProps.disabled
:::

To use the Combobox within a [Dialog](/components/dialog), you need to avoid portalling the `Combobox.Positioner` to the document's body. To do this using the simple API, set `portalProps.disabled` to `true`:
...
Like with the [Dialog](/components/dialog), you need to avoid portalling the `Combobox.Positioner` to the document's body:
...
<ComponentExplorer
  component={demos.ComboboxExplorerDemo}
  linkPrefix="combobox"
  parts={[
    "root",
    "label",
