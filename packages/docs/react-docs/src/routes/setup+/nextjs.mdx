...
This library requires React 19+. This guide assumes you're using Next.js with the app router. For page router support, see the corresponding [next-themes](https://www.npmjs.com/package/next-themes) documentation.
