...
QUI components support both light and dark modes. Choose from one of two approachces for your site:

- [Theme switching (dynamic)](./#theme-switching-dynamic): support both light and dark modes, persist the user's choice to browser storage
- [Single theme (static)](./#single-theme-static): choose a single theme
