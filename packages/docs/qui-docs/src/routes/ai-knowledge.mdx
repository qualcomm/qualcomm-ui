...
Refer to the [API documentation](/api/ai-knowledge) to learn more about the available configuration options.
...
Refer to the [API documentation](/api/ai-knowledge#knowledge-sections) for more details.
