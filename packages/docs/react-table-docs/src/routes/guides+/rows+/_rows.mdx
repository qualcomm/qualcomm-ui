...
If you use grouping or expanding features, your rows may contain sub-rows or parent row references. Detailed information is available in the [Expanding Guide](/feature-guides/row-expansion).
